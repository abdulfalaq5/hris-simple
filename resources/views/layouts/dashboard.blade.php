                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        @if (session('role') == 'Sales')
                            <li class="sidebar-item @if (Request::is('sales') || Request::is('sales/')) active @else '' @endif">
                                <a href="{{ route('sales.dashboard') }}" class='sidebar-link'>
                                    <i class="bi bi-grid-fill"></i>
                                    <span>Dashboard</span>
                                </a>
                            </li>
                            <li class="sidebar-item @if (Request::is('sales/presences*')) active @else '' @endif">
                                <a href="{{ route('sales.presences') }}" class='sidebar-link'>
                                    <i class="bi bi-table"></i>
                                    <span>Presences</span>
                                </a>
                            </li>
                            <li class="sidebar-item @if (Request::is('sales/payrolls*')) active @else '' @endif">
                                <a href="{{ route('sales.payrolls') }}" class='sidebar-link'>
                                    <i class="bi bi-currency-dollar"></i>
                                    <span>Payrolls</span>
                                </a>
                            </li>
                            <li class="sidebar-item @if (Request::is('sales/leave-requests*')) active @else '' @endif">
                                <a href="{{ route('sales.leave-requests') }}" class='sidebar-link'>
